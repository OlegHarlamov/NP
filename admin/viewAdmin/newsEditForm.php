	...
	if(isset($test)){
		...
		<?php 
		 ...
		 <form method='POST' action="newsEditResult?id=<?php echo $id;?>" enctype="multipart/form-data">
	 		...
	 		<tr>
	 			<td>News text</td>
	 			<td><textarea name="text" rows="5" class="form-control"><?php echo $detail['text']; ?></textarea></td>
	 		</tr>
	 		<tr>
	 			<td>Category</td>
	 			<td>
                     ...
                     echo '>'.$row['name'].'</option>';
	 				 ...
	 				 <tr>
	 				 	<td colspan="2">
	 				 		<button type="submit" name="save" ame class="btn btn-primary">
	 				 			<span class="glyphicon glyphicon-backward">Изменить</span>
	 				 		</button>
